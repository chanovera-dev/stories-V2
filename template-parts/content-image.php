<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="post--body">
        <header class="post--body__header glass-bright">
            ...
            <div class="tags">
                <?php
                    ...
                    echo '<a href="' . esc_url( get_post_format_link( 'image' ) ) . '" class="post-format-label tag-type small-text glass-backdrop glass-bright">'
                        . $format_svg . esc_html( __('Imagen', 'stories') ) . '</a>';
                ?>
            </div>
        </header>
