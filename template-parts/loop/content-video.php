        ...
        <header class="post-body__header">
            <div class="category post--tags">
                <?php
                    ...
                    echo '<a href="' . esc_url( get_post_format_link( 'video' ) ) . '" class="post-tag small glass-backdrop glass-bright">'
                    . $format_svg . esc_html( __('Video', 'core') ) . '</a>';
                ?>
            </div>
            <?php 
                // =========================================
            ...
            <a class="post--permalink btn-pagination small-pagination" href="<?php the_permalink(); ?>" aria-label="Ver el video de <?php echo esc_attr( $post_title ); ?>">
