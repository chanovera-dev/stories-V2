            ...
            <div class="post--tags">
                <?php
                    ...
                    $format_svgs = [
                        ...
                        'image'    => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image" viewBox="0 0 16 16"><path d="M6.002 3a2 2 0 1 1-4.004 0 2 2 0 0 1 4.004 0z"/><path d="M14.002 4a1 1 0 0 1 1 1v8a2 2 0 0 1-2 2h-10a2 2 0 0 1-2-2V5a1 1 0 0 1 1-1h12zM1 5v8a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V5H1z"/></svg>',
