...
/**
 * Shortcode para mostrar boletines relacionados
 * Uso: [related_boletines]
 */
function shortcode_related_boletines() {
            ...
            <div class="related-posts--list slideshow">
                <?php 
                    while ( $related_posts->have_posts() ) : 
                        ...
                        get_template_part( 'template-parts/loop/content', 'boletin' );
                    endwhile;
                ?>
            </div>
...
add_shortcode( 'related_boletines', 'shortcode_related_boletines' );