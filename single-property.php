    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div class="property--metadata">
                        ...
                        <ul class="property---metadata--list">
                            <?php
                                ...
                                echo '<li>' . stories_get_metadata_icon('id') . 'ID: ' . esc_html($id) . '</li>';
                                echo '<li>' . stories_get_metadata_icon('location') . esc_html($location) . '</li>';
                                
                                // Display construction size if available
                                if (!empty($construction) && $construction != 0) {
                                    echo '<li>' . stories_get_metadata_icon('construction') . format_numeric($construction) . ' m² de construcción</li>';
                                }
                                
                                // Display lot size if available
                                if (!empty($lot) && $lot != 0) {
                                    echo '<li class="lot">' . stories_get_metadata_icon('lot') . format_numeric($lot) . ' m² de terreno</li>';
                                }
                            ?>
                        </ul>
                    </div>
        ...
        <section class="block posts--body container--related-posts">
            <div class="content related-posts--title">
                <h2><?php echo esc_html_e( 'Propiedades cercanas', 'stories' ); ?></h2>
            </div>
