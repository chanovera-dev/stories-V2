...
<div class="content content-tags">
    <?php
        ...
        echo '<a href="' . esc_url( get_post_format_link( 'quote' ) ) . '" class="post-tag small">'
        . $format_svg . esc_html( __('Cita', 'stories') ) . '</a>';
