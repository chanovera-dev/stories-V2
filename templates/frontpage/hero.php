    ...
    <div class="content text-white text-shadow">
        <div>
            ...
            <?php if ($secondary_button = get_field('cta_secondary_button')): ?>
                ...
                <button class="btn secondary without-line go-to-properties" onclick="window.location.href='<?php echo esc_url($secondary_link); ?>'"><?= esc_html($secondary_button) . stories_get_metadata_icon('right-arrow'); ?></button>
            <?php endif; ?>
            </div>
        </div>
    </div>
