<aside class="properties--filter">
    ...
    <form class="property-filter-form" id="property-filters">
        <!-- Search -->
        <div class="filter">
            <input type="text" name="search" placeholder="<?php esc_html_e('Palabras clave', 'stories'); ?>">
        </div>

        <!-- Operation -->
        <div class="menu-flex">
            <div class="filter-property"><input type="checkbox" name="operation[]" value="sale"><label><?= stories_get_metadata_icon('sale'); esc_html_e('Venta', 'stories'); ?></label></div>
            <div class="filter-property"><input type="checkbox" name="operation[]" value="rental"><label><?= stories_get_metadata_icon('rent'); esc_html_e('Renta', 'stories'); ?></label></div>
        </div>

        <!-- Type -->
        <div class="menu-flex">
            <div class="filter-property"><input type="checkbox" name="type[]" value="casa"><label><?= stories_get_metadata_icon('house'); esc_html_e('Casa', 'stories'); ?></label></div>
            <div class="filter-property"><input type="checkbox" name="type[]" value="bedroom"><label><?= stories_get_metadata_icon('bedroom'); esc_html_e('Habitación', 'stories'); ?></label></div>
            ...
            <div class="filter-property"><input type="checkbox" name="type[]" value="terreno"><label><?= stories_get_metadata_icon('garden'); esc_html_e('Terreno', 'stories'); ?></label></div>
        </div>
        ...
        <ul class="filter-navigation menu">
            ...
            <li class="menu-item-has-children filter price">
                ...
                <ul class="sub-menu">
                    ...
                    <li> 
                        <div>
                            <label><?php esc_html_e('Mínimo', 'stories'); ?></label>
                            <input type="number" name="price_min" placeholder="<?php esc_html_e('Min $', 'stories'); ?>" min="0" value="<?php echo esc_attr(get_query_var('price_range')['min'] ?? 0); ?>">
                        </div>  
                        <div>
                            <label><?php esc_html_e('Máximo', 'stories'); ?></label>    
                            <input type="number" name="price_max" placeholder="<?php esc_html_e('Max $', 'stories'); ?>" min="0" value="<?php echo esc_attr(get_query_var('price_range')['max'] ?? 0); ?>">
                        </div>
            ...
            <li class="menu-item-has-children filter size">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        ...
                        <div><input type="number" name="construction_min" placeholder="<?php esc_html_e('Min m²', 'stories'); ?>" min="0" value="<?php echo esc_attr($construction_range['min'] ?? 0); ?>"></div>
                        <div><input type="number" name="construction_max" placeholder="<?php esc_html_e('Max m²', 'stories'); ?>" min="0" value="<?php echo esc_attr($construction_range['max'] ?? 0); ?>"></div>
                    ...
                    <li>
                        ...
                        <div><input type="number" name="land_min" placeholder="<?php esc_html_e('Min m²', 'stories'); ?>" min="0" value="<?php echo esc_attr($land_range['min'] ?? 0); ?>"></div>
                        <div><input type="number" name="land_max" placeholder="<?php esc_html_e('Max m²', 'stories'); ?>" min="0" value="<?php echo esc_attr($land_range['max'] ?? 0); ?>"></div>
