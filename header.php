    ...
    <header id="main-header" role="banner" aria-label="<?php echo esc_attr__( 'Main header', 'stories' ); ?>">
        <section class="block">
            ...
            <div class="content">
                    ...
                    <form role="search" method="get" id="custom-searchform" class="" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        <div class="section">
                            ...
                            <div class="buttons-container">
                                ...
                                <div class="close-custom-searchform btn-pagination small-pagination" onclick="closeCustomSearchform()">
                ...
                <button id="menu-mobile__button" class="menu-mobile__button" onclick="toggleMenuMobile()" aria-label="button for menu">
                    <span class="bar"></span>
                </button>
            </div>
        </section>
